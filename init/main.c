...
void __init console_on_rootfs(void)
{
	...
	// now I want to take a view of current rootfs
	// first print the / folder's content

	const char* tmpdir_path_str = "/dev";
	struct file *tmpdir = filp_open(tmpdir_path_str, O_RDONLY, 0);
